        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "viewSponsors.php">Sponsors</a></li>';
                    echo '<li><a href = "viewLocations.php">Locations</a></li>';
                    echo '<li><a href = "viewOffers.php">Offers</a></li>';
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron">
                ...
                <p>
                Whether you're looking to book a to spend a good quality time with friends and family, host your own event or promote your offers and expend your work, 
                our dedicated Event planning website can create a package that will meet your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
        </div>
