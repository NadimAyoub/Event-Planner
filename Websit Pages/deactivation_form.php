...
<html>
    ...
    <body>
        ...
        <div class="content">
            <div class="container">
                <h1>Account Deactivation Form</h1>
                <br>
                <br>
                <?php 
                ...
                ?>
                <form action="deactivation.php" method="POST" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="RoleID" name="RoleID" readonly="readonly" value="<?php echo $row['Description']; ?>" />
                        </div>
                        <div class="col-md-4">
                            <span id="roleError" class="error"></span>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-default pull-right" name="Deactivate" id="Deactivate">Deactivate <span class="glyphicon glyphicon-floppy-disk"></span></button>
